...
function Video() {
    ...
    return (_jsxs("div", { className: "right-main", children: [_jsxs("div", { className: "topbar", children: [_jsx("h1", { children: "Video Page" }), _jsxs("div", { className: "upload-section", children: [_jsx("h2", { className: "text-xl font-bold mb-2", children: "Upload Media" }), _jsx("input", { type: "file", multiple: true, accept: "image/*,audio/*,video/*", onChange: handleFileChange, className: "border p-2 rounded" })] })] }), _jsxs("div", { className: "video-main", children: [files.length === 0 && (_jsx("p", { className: "text-gray-500", children: "No files chosen yet" })), files.map((file, index) => {
